---
title: "Wondr Health Case Study - Statistical Analysis"
...
```{r data import}
fct_weights <- read_xlsx(path = "CaseStudyDataSet2024.xlsx", sheet = "fct_weights")
dim_project_dates <- read_xlsx(path = "CaseStudyDataSet2024.xlsx", sheet = "dim_project_dates")
